...
// Date: Sep 14th, 2023
//
// Changed which NeoPixels are being used
//
//---------------------------------------------------------
...
Adafruit_NeoPixel pixels(NUMPIXELS, NEOPIXELS_PIN, NEO_GRBW + NEO_KHZ800);
...
const color_t LIGHT_ORANGE = {
		90,
		40,
		10};

const color_t LIGHT_RED = {
		110,
		30,
		0};

color_t plen[NUM_CHANNELS] = {
		LIGHT_YELLOW,
		LIGHT_ORANGE,
		LIGHT_RED,
		RED};

color_t actv[NUM_CHANNELS] = {
		BLUE,
		BLUE,
		BLUE,
		BLUE};
...
void displayLedRing()
{
	...
	switch (edit_mode)
	{
		case EDIT_MODE_PATTERN_LEN:
			for (int i = 0; i < pattern_length[curChannel]; i++)
			{ // For each pixel...
