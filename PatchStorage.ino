...
{
	Serial.print("setSlotTaken for slot: ");
	Serial.print(slotNum);
	Serial.println();
	if (slotNum > 15 || slotNum < 0)
	{
...
byte storeChan(int slotNum, int chan)
{
	...
	Serial.print("storeChan at offset: ");
...
{
	Serial.print("storeCurrentPatchToSlot for slot: ");
	Serial.print(slotNum);
	Serial.println();
...
void loadCurrentPatchFromSlot(int slotNum)
{
	...
	{
		Serial.print("BAD slot: ");
		Serial.print(slotNum);
		Serial.println();
		return;
	}
	Serial.print("loadCurrentPatchFromSlot for slot: ");
	Serial.print(slotNum);
	Serial.println();
